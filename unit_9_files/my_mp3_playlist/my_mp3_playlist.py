...
def my_mp3_playlist(file_path):
    with open(file_path, "r") as file1:
        ...
        for formatted_song in formatted_list:
            ...
            times_mentioned_so_far = 0
            if artist_name in artist_dict:
                times_mentioned_so_far = artist_dict[artist_name]
            artist_dict[artist_name] = times_mentioned_so_far + 1
            if artist_dict[artist_name] > artist_mentioned_most[1]:
